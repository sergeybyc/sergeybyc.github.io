...
<main class="gallery">
	...
	{% for img in site.data.gallery.anapa2020.urls %}
	<div class="grid-item">
		<a href="{{img}}" data-fslightbox><img src="/assets/img/transparent.gif" data-original="{{img}}" alt="{{site.data.gallery.anapa2020.alt}}"></a>
	</div>
	{% endfor %}
</main>
